...
export default function ApplicationDetail() {
  ...
  return (
    <div>
      ...
      <div className="appdetail-layout">
            ...
            <div className="appdetail-header">
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", flexShrink: 0 }}>
                ...
                <button
                  ...
                  disabled={screening}
                  style={{ color: "var(--accent)", borderColor: "rgba(196,98,45,0.3)" }}
                >
                  {screening
                    ? <><span className="spinner" style={{ width: 12, height: 12, borderWidth: 2 }} /> Screening…</>
                    : <><Bot size={14} /> Run AI Screen</>
                  }
                </button>
              </div>
            </div>
            ...
            <div className="card" style={{
              ...
              {app.ai_screened_at && (
                <p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 8 }}>
                  Screened at {formatDate(app.ai_screened_at)}
                </p>
              )}
            </div>
          )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {/* Candidate card */}
          <div className="card">
            <h4 style={{ fontWeight: 700, marginBottom: 12, fontSize: 13, color: "var(--text-muted)", textTransform: "uppercase" }}>
              Candidate
            </h4>
            <Link to={`/candidates/${app.candidate_detail?.id}`} style={{ textDecoration: "none" }}>
              <div style={{
                padding: 10, background: "var(--bg-elevated)",
            ...
            <Link to={`/jobs/${app.requisition_detail?.id}`} style={{ textDecoration: "none" }}>
              ...
              >
                ...
                <p style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 3 }}>
                  {app.requisition_detail?.department_detail?.name}
                </p>
              </div>
            </Link>
          </div>
          ...
          {app.reviewer_notes && (
            <div className="card">
              <h4 style={{ fontWeight: 700, marginBottom: 8, fontSize: 13, color: "var(--text-muted)", textTransform: "uppercase" }}>
                Reviewer Notes
              </h4>
